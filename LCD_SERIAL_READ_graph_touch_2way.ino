...
void Thermo(int Ttemp, int Tset) {
   uint16_t tx, ty;
uint16_t choosenColor = 0;
    int16_t xpos = 0;
    int16_t ypos = 128;
  ...
  tft.setFontScale(3);tft.setTextColor(RA8875_WHITE, RA8875_BLACK);tft.setCursor(105, 220);tft.setTextColor(RA8875_WHITE, RA8875_BLACK);tft.print(Ttemp);
